...
const { getUsers, createUser, updateUserId, deleteUserId, getUserId, refreshToken, emailAjax, getUserDocumento, 
    updateUserDocumento, deleteUserDocumento, getUserCodigo, updateUserCodigo, deleteUsercodigo, updatePass, 
    updateDataUserId, updateImagenUserId, deleteImagenUserId, getColor, getInfoProfesor,
    updateUser    
